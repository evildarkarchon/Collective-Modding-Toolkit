...
from PySide6.QtWidgets import (
    ...
    QGridLayout, QFrame, QTabWidget, QSizePolicy
)
...
class AboutTab(CMCTabWidget):
    ...
    def _build_gui(self) -> None:
        ...
        self.main_layout.addWidget(title_label, 0, 0, Qt.AlignCenter)
        ...
        icon_label.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
        self.main_layout.addWidget(icon_label, 1, 0, Qt.AlignCenter)
        self.main_layout.setRowSpacing(1, 20)  # Bottom padding
        ...
        info_label = QLabel(
            ...
            f"Collective Modding Community\n#cm-toolkit on Discord"
        )
        ...
        # Nexus frame
        frame_nexus = self._create_link_frame(
            "images/logo-nexusmods.png",
            "Open Link",
            "Copy Link",
            NEXUS_LINK
        )
        frame_layout.addWidget(frame_nexus, alignment=Qt.AlignRight)
        frame_layout.addSpacing(10)
        
        # Discord frame
        frame_discord = self._create_link_frame(
            "images/logo-discord.png",
            "Open Invite",
            "Copy Invite",
            DISCORD_INVITE
        )
        frame_layout.addWidget(frame_discord, alignment=Qt.AlignRight)
        frame_layout.addSpacing(10)
        
        # GitHub frame
        frame_github = self._create_link_frame(
            "images/logo-github.png",
            "Open Link",
            "Copy Link",
            GITHUB_LINK
        )
        frame_layout.addWidget(frame_github, alignment=Qt.AlignRight)
    ...
    def _reset_button(self, button: QPushButton, original_text: str) -> None:
