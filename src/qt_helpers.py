...
class CMCheckerInterface(Protocol):
	...
	# Required attributes to match Tkinter interface
...
class CMCTabWidget(QWidget):
	...
	def load(self) -> None:
		...
		# Add to layout
		self.main_layout.addWidget(self.label_loading, 0, 0, Qt.AlignmentFlag.AlignCenter)
...
class LoadingThread(QThread):
	...
	def __init__(self, load_func: Callable[[], bool]) -> None:
		super().__init__()
	...
	def run(self) -> None:
		try:
			...
			self.finished.emit(False, str(e))  # noqa: FBT003
